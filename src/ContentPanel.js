...
function ContentPanel() {
  return (
    <div className="bg-white text-black p-4 border-2 border-solid rounded h-full grid grid-cols-3 grid-rows-10 gap-4">
      <div className="col-span-2 row-span-1">
        <h1 className="font-bold text-3xl text-center">Hello la team</h1>
      </div>
      <div className="col-span-2 row-span-9 overflow-auto">
        <div className="mt-4">
